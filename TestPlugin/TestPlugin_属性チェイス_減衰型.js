 ...
 * @help
 * 
 *  プラグインコマンド --- 必ずこのプラグインコマンドをステート付与スキルで実行してください。
 *     SetChaseElement x y
 *         x: チェイス発動時に実行される攻撃スキルのID
 *         y: チェイス発動率の減衰率（0~1の少数）、1ならば必ず発動する
 * 
 * ============= Parameters ====================
 *
...
Imported.TestPlugin_属性チェイス_減衰型 = true;

var FAL = FAL || {};

FAL.Parameters = PluginManager.parameters('TestPlugin_属性チェイス_減衰型');
FAL.Param = FAL.Param || {};
